...
public class RegisterBlocks {
    ...
    public static final Block CAFFEINE_BLOCK = Registry.register(Registry.BLOCK, new Identifier(MOD_ID, "caffeine_block"), new Block(FabricBlockSettings.of(Material.SNOW_BLOCK).mapColor(MapColor.PALE_YELLOW).hardness(0.2f).resistance(0.2f).sounds(BlockSoundGroup.SNOW)));
    ...
    public static final Block COFFEE_BUSH = Registry.register(Registry.BLOCK, new Identifier(MOD_ID, "coffee_bush"), new CoffeeBush(AbstractBlock.Settings.of(Material.PLANT).ticksRandomly().noCollision().sounds(BlockSoundGroup.SWEET_BERRY_BUSH)));
